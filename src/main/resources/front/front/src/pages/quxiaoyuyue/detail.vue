		...
		<div class="attr" :style='{"minHeight":"580px","padding":"20px","position":"relative","background":"#ebf0f4","display":"flex"}'>
			...
			<div class="info" :style='{"width":"calc(100% - 400px)","padding":"10px","margin":"0 0 0 10px","background":"#e5e5e5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>预约单号</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.yuyuedanhao}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>预约时间</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.yuyueshijian}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>取消时间</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.quxiaoshijian}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>取消原因</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.quxiaoyuanyin}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>姓名</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.xingming}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>手机</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.shouji}}</div>
				</div>
			</div>
