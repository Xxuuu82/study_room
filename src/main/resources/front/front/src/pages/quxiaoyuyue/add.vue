    ...
    >
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="预约单号" prop="yuyuedanhao">
            <el-input v-model="ruleForm.yuyuedanhao" 
                placeholder="预约单号" clearable readonly></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="取消时间" prop="quxiaoshijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="取消原因" prop="quxiaoyuanyin">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="取消原因"
