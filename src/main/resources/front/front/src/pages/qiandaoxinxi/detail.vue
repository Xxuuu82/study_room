		...
		<div class="attr" :style='{"minHeight":"580px","padding":"20px","position":"relative","background":"#ebf0f4","display":"flex"}'>
			...
			<div class="info" :style='{"width":"calc(100% - 400px)","padding":"10px","margin":"0 0 0 10px","background":"#e5e5e5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.mingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>签到时间</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.qiandaoshijian}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>签到备注</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.qiandaobeizhu}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>班级</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.banji}}</div>
				</div>
        ...
        init() {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.detail.id, {}).then(res => {
            if (res.data.code == 0) {
              ...
              this.detailBanner = this.detail.renlianshibie ? this.detail.renlianshibie.split(",") : [];
              this.$forceUpdate();
            }
          });
