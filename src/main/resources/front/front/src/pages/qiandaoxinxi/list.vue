...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"rgba(0,0,0,0.102)","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"2px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>签到时间</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
		  :style='{"border":"2px solid #2E61E1","padding":"3px 10px","outline":"none","borderRadius":"8px","background":"#BFD2FC","width":"auto","justifyContent":"center"}'
	  ...
	  <el-button v-if="isAuth('qiandaoxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#2E61E1","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/qiandaoxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"minHeight":"1100px","margin":"0 0 10px","background":"rgba(0,0,0,0.102)","height":"auto"}'>
		...
		<div class="list2 index-pv1" :style='{"width":"100%","padding":"20px 10px","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
			<div :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","padding":"20px 5px","margin":"10px","background":"#ffff","display":"flex","width":"30%","fontSize":"0","position":"relative","height":"300px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"width":"50%","margin":"0","objectFit":"cover","height":"250px"}' v-if="item.renlianshibie && item.renlianshibie.substr(0,4)=='http'" :src="item.renlianshibie" class="image" />
				<img :style='{"width":"50%","margin":"0","objectFit":"cover","height":"250px"}' v-else :src="baseUrl + (item.renlianshibie?item.renlianshibie.split(',')[0]:'')" class="image" />
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('qiandaoxinxi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/qiandaoxinxiDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
