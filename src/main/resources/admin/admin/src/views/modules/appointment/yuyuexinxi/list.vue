    ...
    <div class="list-preview" :style='{"width":"100%","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0 auto","position":"relative","background":"#fff","boxSizing":"border-box","padding":"0"}'>
      ...
      <div class="table-container" :style='{"padding":"20px"}'>
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-tag :type="scope.row.qiandaozhuangtai === '已签到' ? 'success' : 'danger'" style="borderRadius: 12px; padding: 2px 10px; margin-left: 8px;">
          ...
          >
            <template slot-scope="scope">
              <el-tag :type="scope.row.qiantuizhuangtai === '已签退' ? 'success' : 'danger'" style="borderRadius: 12px; padding: 2px 10px; margin-left: 8px;">
          ...
          >
            <template #default="{ row }">
              <el-tag :type="row.sfsh ? 'success' : 'warning'" style="borderRadius: 12px; padding: 2px 10px; margin-left: 8px;">
                {{ row.sfsh || "待回复" }}
              </el-tag>
            </template>
          </el-table-column>
      ...
      <div v-if="currentDetailData" style="padding: 20px;">
        <el-descriptions :column="2" border>
          <el-descriptions-item label="预约单号">
            <span style="font-weight: 600; color: #333;">{{ currentDetailData.yuyuedanhao || "-" }}</span>
          </el-descriptions-item>
          <el-descriptions-item label="名称">
            {{ currentDetailData.mingcheng || "-" }}
          </el-descriptions-item>
          <el-descriptions-item label="座位">
            {{ currentDetailData.zuowei || "-" }}
          </el-descriptions-item>
          <el-descriptions-item label="预约时间">
            {{ currentDetailData.yuyueshijian || "-" }}
          </el-descriptions-item>
          <el-descriptions-item label="签到状态">
            <el-tag :type="currentDetailData.qiandaozhuangtai === '已签到' ? 'success' : 'danger'" style="margin-left: 8px;">
              {{ currentDetailData.qiandaozhuangtai || "未签到" }}
            </el-tag>
          </el-descriptions-item>
          <el-descriptions-item label="签退状态">
            <el-tag :type="currentDetailData.qiantuizhuangtai === '已签退' ? 'success' : 'danger'" style="margin-left: 8px;">
              {{ currentDetailData.qiantuizhuangtai || "未签退" }}
            </el-tag>
          </el-descriptions-item>
          ...
          <el-descriptions-item label="备注" :span="2">
            {{ currentDetailData.qiantuibeizhu || "无备注" }}
          </el-descriptions-item>
          <el-descriptions-item label="回复状态" :span="2">
            <el-tag :type="currentDetailData.sfsh ? 'success' : 'warning'" style="margin-left: 8px;">
              {{ currentDetailData.sfsh || "待回复" }}
            </el-tag>
          </el-descriptions-item>
          <el-descriptions-item v-if="currentDetailData.shhf" label="回复内容" :span="2">
            {{ currentDetailData.shhf }}
          </el-descriptions-item>
    ...
    >
      <div v-if="currentEditData" style="padding: 20px;">
        <el-form
          ...
          label-position="left"
        >
          <el-form-item label="预约单号" prop="yuyuedanhao">
            <el-input
              v-model="currentEditData.yuyuedanhao"
              placeholder="请输入预约单号"
              :disabled="true"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="预约时间" prop="yuyueshijian">
            <el-input
              v-model="currentEditData.yuyueshijian"
              placeholder="请输入预约时间"
              :disabled="true"
            ></el-input>
          </el-form-item>

          <el-form-item label="签到状态" prop="qiandaozhuangtai">
            <el-select v-model="currentEditData.qiandaozhuangtai" placeholder="请选择签到状态" style="width: 100%; padding-left: 8px;">
              <el-option label="已签到" value="已签到" style="padding-left: 8px;"></el-option>
              <el-option label="未签到" value="未签到" style="padding-left: 8px;"></el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="签退状态" prop="qiantuizhuangtai">
            <el-select v-model="currentEditData.qiantuizhuangtai" placeholder="请选择签退状态" style="width: 100%; padding-left: 8px;">
              <el-option label="已签退" value="已签退" style="padding-left: 8px;"></el-option>
              <el-option label="未签退" value="未签退" style="padding-left: 8px;"></el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="备注" prop="qiantuibeizhu">
            <el-input
              type="textarea"
              v-model="currentEditData.qiantuibeizhu"
              placeholder="请输入备注"
              :rows="3"
            ></el-input>
          </el-form-item>

          <el-form-item label="回复状态" prop="sfsh">
            <el-select v-model="currentEditData.sfsh" placeholder="请选择回复状态" style="width: 100%; padding-left: 8px;">
              <el-option label="已回复" value="已回复" style="padding-left: 8px;"></el-option>
              <el-option label="待回复" value="待回复" style="padding-left: 8px;"></el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="回复内容" prop="shhf" v-if="currentEditData.sfsh === '已回复'">
            <el-input
              type="textarea"
              v-model="currentEditData.shhf"
              placeholder="请输入回复内容"
              :rows="3"
            ></el-input>
          </el-form-item>
